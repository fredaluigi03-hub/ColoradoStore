      ...
      <div className="mx-auto max-w-[1600px] px-4 md:px-8 py-16">
        ...
        <div className="mt-12 pt-8 border-t border-carta/10 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              onClick={scrollToTop}
              className="btn-3d btn-3d-gold px-5 py-2.5 rounded-full bg-sabbia text-inchiostro label text-[10px] font-bold tracking-widest flex items-center gap-2 shadow-lg"
            >
